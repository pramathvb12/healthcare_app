...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edEmail = findViewById(R.id.editTextUserMail);
                ...
                if(username.length() == 0 || password.length() == 0 || confpassword.length() == 0 || email.length() == 0){
                    ...
                    if(password.compareTo(confpassword) == 0){
                        if(isValid(password)){
                            ...
                            Toast.makeText(getApplicationContext(),"Password must contain digit,number or character",Toast.LENGTH_SHORT).show();
                        }
                    }else{
